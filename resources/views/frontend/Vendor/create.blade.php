            ...
            <form action="{{ url('vendor/product/store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="type">
                        <option selelect disabled>Select A Product type</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="category_id">
                        <option selelect disabled>Select A CAtegory</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="color_id">
                        <option selelect disabled>Select A color</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="size_id">
                        <option selelect disabled>Select A size</option>
                ...
                <div class="form-group">
                    <label>QTY</label>
                    <input type="text" name="qty" min="1" value="{{ old('QTY') }}" class="form-control" placeholder="Enter Product QTY">
                </div>
                <div class="form-group">
                    <label>Image</label>
